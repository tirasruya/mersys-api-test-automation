...
public class StudentGroupRequest {
    ...
    private String id;            // update için
    private String name;
    private String description;
    private boolean active;
    private boolean publicGroup;  // API alan adı “public” olamaz (Java keyword), o yüzden publicGroup
    private boolean visibility;   // excel’de “visibility to students” gibi bir alan vardı
